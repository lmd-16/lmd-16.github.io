    ...
    return (
        ...
        <section className="pt-40 px-10 flex flex-col items-start max-w-5xl mx-auto text-center">
            ...
            <div className="card w-72 bg-base-100 shadow-sm">
                ...
                <div className="card-actions flex justify-end flex-wrap gap-2 mt-2">
            ...
            <div className="card w-72 bg-base-100 shadow-sm">
                ...
                <p className="text-xs">
                    Inspired by the video game <strong>Celeste</strong>, this portfolio embraces game-like aesthetics and storytelling.
                </p>
                <div className="card-actions flex justify-end flex-wrap gap-2 mt-2">
            ...
            <div className="card w-72 bg-base-100 shadow-sm">
                ...
                <p className="text-xs">
                    Check out my code and explore other projects I’ve worked on.
                </p>
                <div className="card-actions flex justify-end flex-wrap gap-2 mt-2">
